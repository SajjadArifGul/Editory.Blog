...
namespace Editory.Blog.Shared.Helpers.URLHelpers
{
    public static class WebURLHelper
    {
        ...
        public static string BlogPost(this UrlHelper helper, int contentID, string postTitle = "", string lang = "")
        {
            string routeURL = string.Empty;
            ...
            {
                routeValues.Add("postTitle", postTitle);
            }
            ...
            routeURL = helper.RouteUrl("BlogPost", routeValues);
